...
export const LEVELS = [
  ...
  },
  {
    ...
    showMiddleHint: true,
    slowSeekerRace: true,
    intro: "20 doors. 5 moves. Split the remaining doors to find the treasure!",
  },
  {
    id: 5,
    name: "The Legend",
    ...
    showMiddleHint: true,
    slowSeekerRace: true,
    intro: "100 doors. 7 moves. Split the hallway in half each time to win!",
    introBinary: "100 doors. 7 moves. If you use binary search perfectly, you can always win!",
  },
];
